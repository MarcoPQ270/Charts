...
<thead>
    <tr><th>id producto</th><th>nombre producto</th><th>precio</th><th>stock</th><th>categoria</th></tr>
    </thead>
    <tbody>";
foreach ($res as $tupla) {
    ...
    <i class='material-icons edit' data-no = '$idp' data-nom='$nompro' data-edad = '$precio'></i>
    </td></tr>";
}
echo "</tbody>
</table>";
